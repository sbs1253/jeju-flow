    ...
    <TooltipProvider delay={200}>
      <Tooltip>
        <TooltipTrigger>
          ...
          >
            <Card className="relative border-border/50 bg-card/80 backdrop-blur-xl shadow-2xl overflow-hidden group">
        ...
        <TooltipContent side="bottom" className="bg-popover border-border text-popover-foreground text-[10px] px-3 py-2 font-medium">
          네이버 데이터랩 기준: 최대 검색량을 100으로 둔 상대적 비율값입니다.
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  );
