    ...
    <TooltipProvider delay={200}>
      <Tooltip>
        <TooltipTrigger className="w-full text-left">
          ...
          >
            <Card className="relative border-border/50 hover:border-border/80 transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-black/5 overflow-hidden group cursor-help">
